...
public class KaufvertragPDF   {
    public static void main(String[] args) throws  IOException {
        ...
        //Paragraph 1
        Paragraph p1 = new Paragraph("Vertragspartner").setFontColor(new DeviceRgb(50,100,150)).setFontSize(20).setBold();
        p1.add("\n");
        p1.add("\n");
        //Paragraph 2
       ...
       //Paragraph 3
        ...
        //Paragraph 6
        Paragraph p6 = new Paragraph("Vekaufte Ware").setFontColor(new DeviceRgb(75,40,90)).setFontSize(16).setBold();
        p6.add("\n");
        //Paragraph 7
        ...
        //Paragraph 8
        Paragraph p8 = new Paragraph(" Achtung Keine Rückerstattung möglich!").setFontSize(6).setBold().setUnderline();
